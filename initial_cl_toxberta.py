...
data_set_up =   [
        ...
        # {
        #         "type":"from_g_to_miso_to_raci",
        #         "train_test": ["davidson", "founta_hateful_57k", "ibereval", "evalita", "hateval-women", "waseem-sexism", "hateval-immigrant", "waseem-racism"],
        #         "zero": [],
        #         "epochs_array": [8, 8, 8, 8, 8, 8, 8, 8],
        #         "training_ks":  None,
...
cl_techniques = ["ewc", "agem", "lwf", "mas", "vainilla_finetune", "zero_shot"]
...
filter_cl_techniques = ['ewc', 'agem', 'lwf', 'mas']
...
for experiment in experiments_cl:
    ...
    results, model =  continual_learning(model,
                            ...
                            loss_f,
                            optimizer,
                            exp_setup) # loaded exp_setup earlier

    experiment_json_name = "_".join([type_experiment, model_id.replace("/", "-"), cl_technique]) + ".json"
